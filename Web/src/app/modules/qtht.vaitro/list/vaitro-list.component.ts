...
@Component({
  selector: 'app-vaitro-list[class="app-module-warp"]',
  templateUrl: './vaitro-list.component.html',
  providers: [VaiTroService]
})
export class VaiTroListComponent implements OnInit {
  ...
  create() {
    this.router.navigateByUrl('qtht-vaitro/form/new');
  }

  showDetail(item) {
    this.router.navigateByUrl('qtht-vaitro/form/' + item.id);
  }
