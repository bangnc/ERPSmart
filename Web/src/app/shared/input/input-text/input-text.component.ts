import { Component, OnInit, Input, Output, HostBinding, forwardRef, EventEmitter } from '@angular/core';
import {
...
export class InputTextComponent implements ControlValueAccessor, OnInit, Validator {
