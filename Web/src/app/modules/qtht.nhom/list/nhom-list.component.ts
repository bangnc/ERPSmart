...
@Component({
  selector: 'app-nhom-list[class="app-module-warp"]',
  templateUrl: './nhom-list.component.html',
  providers: [NhomService]
})
export class NhomListComponent implements OnInit {
  ...
  create() {
    this.router.navigateByUrl('qtht-nhom/form/new');
  }

  showDetail(item) {
    this.router.navigateByUrl('qtht-nhom/form/' + item.id);
  }
