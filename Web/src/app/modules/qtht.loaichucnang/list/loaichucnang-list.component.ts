...
@Component({
  selector: 'app-loaichucnang-list[class="app-module-warp"]',
  templateUrl: './loaichucnang-list.component.html',
  providers: [LoaiChucNangService]
})
export class LoaiChucNangListComponent implements OnInit {

  data: Array<any>;
  url = 'api/qtht-loaichucnang';
  meta: MetaStruct;
  idx: any;
  ...
  ngOnInit(): void {
    ...
    this.pageOption.sort = { 'module.so_thu_tu': 1, 'so_thu_tu': 1 };
  ...
  create() {
    this.router.navigateByUrl('qtht-loaichucnang/form/new');
  }

  showDetail(item) {
    this.router.navigateByUrl('qtht-loaichucnang/form/' + item.id);
  }
