...
@Component({
  selector: 'app-dieuhuong-list[class="app-module-warp"]',
  templateUrl: './dieuhuong-list.component.html',
  providers: [DieuHuongService]
})
export class DieuHuongListComponent implements OnInit {

  data: Array<any>;
  url = 'api/qtht-dieuhuong';
  meta: MetaStruct;
  idx: any;
  ...
  create() {
    this.router.navigateByUrl('qtht-dieuhuong/form/new');
  }

  showDetail(item) {
    this.router.navigateByUrl('qtht-dieuhuong/form/' + item.id);
  }
